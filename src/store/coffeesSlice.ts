...
const coffeesSlice = createSlice({
  ...
  reducers: {
    ...
    updateCoffees: (state: ICoffeeSlice, action: PayloadAction<any>) => {
      const tempCoffees = state.coffees;
      const filterCoffees = tempCoffees.filter((coffee) => coffee.id !== action.payload.id);
  ...
  extraReducers: (builder) => {
    builder
      .addCase(GetCoffeesThunk.rejected, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.FAILED;
        state.errors = action.payload;
      })
      .addCase(GetCoffeesThunk.pending, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.LOADING;
      })
      .addCase(GetCoffeesThunk.fulfilled, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.SUCCEEDED;
        state.coffees = action.payload;
      })
      .addCase(GetMyCoffeesThunk.rejected, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.FAILED;
        state.errors = action.payload;
      })
      .addCase(GetMyCoffeesThunk.pending, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.LOADING;
      })
      .addCase(GetMyCoffeesThunk.fulfilled, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.SUCCEEDED;
        state.myCoffees = action.payload;
      })
      .addCase(AddCoffeeThunk.rejected, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.FAILED;
        state.errors = action.payload;
      })
      .addCase(AddCoffeeThunk.pending, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.LOADING;
      })
      .addCase(AddCoffeeThunk.fulfilled, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.SUCCEEDED;
        state.addedCoffee = action.payload;
      })
      .addCase(UpdateCoffeeThunk.rejected, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.FAILED;
        state.errors = action.payload;
      })
      .addCase(UpdateCoffeeThunk.pending, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.LOADING;
      })
      .addCase(UpdateCoffeeThunk.fulfilled, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.SUCCEEDED;
      })
      .addCase(RemoveCoffeeThunk.rejected, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.FAILED;
        state.errors = action.payload;
      })
      .addCase(RemoveCoffeeThunk.pending, (state: ICoffeeSlice, action: PayloadAction<any>) => {
        state.coffeesStatus = STATUS.LOADING;
      })
...
export const AddCoffeeThunk = createAsyncThunk("coffee/add", async (coffee: any) => {
  const response = await AddCoffeesService(coffee);
  return response;
});

export const UpdateCoffeeThunk = createAsyncThunk("coffee/update", async (coffee: any) => {
